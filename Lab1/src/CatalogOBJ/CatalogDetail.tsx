  ...
  useEffect(() => {
    ...
    const demoAnimes: { [key: string]: AnimeDetail } = {
      "1": {
        ...
        year: 2026,
        rating: 8.5,
        description: "Сноуфилд — неприметный город на западе США, расположенный севернее Лас-Вегаса. С одной стороны его окружают лесные массивы и озёрные берега, с другой — безжизненные пустоши и глубокие каньоны. Это место редко привлекает путешественников, и кажется, что здесь попросту не может произойти ничего необычного." +

                      "Однако именно здесь Ассоциация магов Соединённых Штатов в строжайшей тайне долгие годы изучала обряд призыва Святого Грааля. Спустя семь десятилетий было принято решение перейти от теории к практике. Выбрав Сноуфилд ареной ритуала, американские маги положили начало новой Войне за Святой Грааль, создав её по ошибочной копии Третьей войны, происходившей в Фуюки. Эта версия конфликта оказалась неполноценной и претерпела серьёзные отличия: в ней отсутствует слуга класса Сэйбер, а также допускается призыв необычных, гибридных существ, не являющихся классическими героями мифов и преданий. В результате само понятие «герой» в этой войне теряет чёткие границы.",
